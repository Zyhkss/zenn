...
`.trim()
	          ...
	          case 'normal':
                                  ...
                                  let Zyhkss8 = `${rbrbs8}`
                                  let Zyhkss9 = `${rbrbs9}`
                                  let Zyhkss10 = `${rbrbs10}`
                                  let Zyhkss11 = `${rbrbs11}`
                                  let Zyhkss12 = `${rbrbs12}`
...
`.trim()
	          ...
	          case 'hard':
                                  ...
                                  let Zyhksss1 = `${rbrbsh1}`
                                  let Zyhksss2 = `${rbrbsh2}`
                                  let Zyhksss3 = `${rbrbsh3}`
                                  let Zyhksss4 = `${rbrbsh4}`
                                  let Zyhksss5 = `${rbrbsh5}`
                                  let Zyhksss6 = `${rbrbsh6}`
                                  let Zyhksss7 = `${rbrbsh7}`
                                  let Zyhksss8 = `${rbrbsh8}`
                                  let Zyhksss9 = `${rbrbsh9}`
                                  let Zyhksss10 = `${rbrbsh10}`
                                  let Zyhksss11 = `${rbrbsh11}`
                                  let Zyhksss12 = `${rbrbsh12}`
...
`.trim()
	          ...
	          case 'extreme':
                                  ...
                                  let Zyhkssse1 = `${rbrbshe1}`
                                  let Zyhkssse2 = `${rbrbshe2}`
                                  let Zyhkssse3 = `${rbrbshe3}`
                                  let Zyhkssse4 = `${rbrbshe4}`
                                  let Zyhkssse5 = `${rbrbshe5}`
                                  let Zyhkssse6 = `${rbrbshe6}`
                                  let Zyhkssse7 = `${rbrbshe7}`
                                  let Zyhkssse8 = `${rbrbshe8}`
                                  let Zyhkssse9 = `${rbrbshe9}`
                                  let Zyhkssse10 = `${rbrbshe10}`
                                  let Zyhkssse11 = `${rbrbshe11}`
                                  let Zyhkssse12 = `${rbrbshe12}`

                                 let hslse = `
*《 Hasil Memancing Kali Ini 》*
 *🦀 = [ ${Zyhkssse2} ]*			*🐠 = [ ${Zyhkssse6} ]*
 *🦞 = [ ${Zyhkssse8} ]*			 *🐟 = [ ${Zyhkssse11} ]*
 *🦐 = [ ${Zyhkssse10} ]*			 *🐬 = [ ${Zyhkssse7} ]*
 *🦑 = [ ${Zyhkssse4} ]*			 *🐳 = [ ${Zyhkssse12} ]*
 *🐙 = [ ${Zyhkssse3} ]*			 *🦈 = [ ${Zyhkssse9} ]*
  *🐡 = [ ${Zyhkssse5} ]*			*🐋 = [ ${Zyhkssse1} ]*
