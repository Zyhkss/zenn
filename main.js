...
async function connectionUpdate(update) {
  ...
  if (update.receivedPendingNotifications) conn.sendMessage(`6281528745589@s.whatsapp.net`, {text: 'Successfully connected by Zyhkss' }) //made by Muhammad Ridwan Reynaldy 
}
