...
* My WhatsApp [`Click Here`](https://wa.me/6281528745589?text=Assalamualaikum)

## Heroku Buildpack
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Zyhkss/Zenn)
...
git clone https://github.com/Zyhkss/Zenn
cd Zyhkss-MD
pkg install yarn
yarn
...
Now set using switch [enable.js](https://github.com/Zyhkss/Zenn/blob/master/plugins/enable.js), among others are
